...
export default function ProfileView() {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setEditing(false);
            // Refresh logic - in a real app, you'd update context or re-fetch
                ...
                <div className="bg-white dark:bg-surface-dark rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 p-8">
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="relative group">
                            ...
                            <button className="absolute -bottom-2 -right-2 p-2 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 text-slate-500 hover:text-primary transition-all">
                                <Edit2 size={16} />
                            </button>
                        </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                {!editing && (
                                    <button 
                                        ...
                                        className="flex items-center gap-2 px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-primary hover:border-primary/30 transition-all bg-slate-50 dark:bg-slate-900/50"
                                    >
                                        <Edit2 size={14} />
                                        Edit Profile
                                    </button>
                    ...
                    {/* Form Section */}
                    {editing ? (
                        <form onSubmit={handleSave} className="mt-12 space-y-8 animate-in fade-in zoom-in-95 duration-300">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all text-sm font-medium"
                                        />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative opacity-60">
                                        ...
                                        <input 
                                            ...
                                            className="w-full pl-12 pr-4 py-3 bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-2xl cursor-not-allowed text-sm font-medium"
                                        />
                                    </div>
                                </div>
                                <div className="space-y-2">
                            ...
                            <div className="flex items-center justify-end gap-4 pt-4 border-t border-slate-50 dark:border-slate-800">
                                <button 
                                    ...
                                    className="px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-900 transition-all"
                                >
                                    Cancel
                                </button>
                                <button 
                                    type="submit"
                                    disabled={saving}
                                    className="flex items-center gap-2 px-8 py-3 rounded-2xl bg-primary text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all disabled:opacity-50"
                                >
